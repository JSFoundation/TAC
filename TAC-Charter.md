...
The Technical Advisory Committee will operate transparently, openly,
...
This Technical Advisory Committee Charter reflects a carefully constructed,
balanced role for the TAC and the Board in the governance of the jQuery
Foundation. The charter amendment process is for the TAC to propose changes
using simple majority of the full TAC, the proposed changes being subject to
review and approval by the Board. The Board may additionally make amendments to
the TAC charter at any time, though the Board will not interfere with day-to-day
discussions, votes or meetings of the TAC.

## Section 3. Board's Role in Setting jQuery Foundation's Strategic Direction

The Board will set the overall TAC Policy through [Foundation mission and vision
...
Foundation's technical vision and direction. The Board will use the TAC as a
delegate body for governing high-level technical policy and procedures as well
as TAC scope and direction while they remain within the scope and direction of
the policies as described in the TAC Policy and approved by the Board.

## Section 4. Establishment of the TAC

TAC memberships are time-limited to 1 year terms with no limit on the number of
terms a member may serve. There is no fixed size of the TAC and membership will
consist of:
...
## Section 5. Responsibilities of the TAC and CBs
...
Foundation Projects. Specific technical decisions within a Project will be the
responsibility of the Project or if the project is a member of a CB, as defined
by the CB charter, including:
...
The TAC will serve as the jQuery Foundation's primary technical liaison body
with external open source projects, consortiums and groups and is also
responsible for technical participation in standards bodies.

## Section 6. jQuery Foundation Operations

Following established Foundation policies and under the guidance of the TAC,
CBs will establish and maintain a development process for jQuery Foundation
...
appropriate timelines for CB review (e.g. agenda items must be published at
least a certain number of hours in advance of a CB meeting).

There will be multiple Projects under the jQuery Foundation organized by CB or a
group of At-large Projects. The CBs are responsible for organizing the Project
structure, including possibly the creation and alignment of sub-Projects. Each
Project must be within such policies as may be set by the Board and TAC, have a
well-defined scope and must work within that scope. The development process will
provide for Projects to follow the lifecycle process as described in the Project
Lifecycle document. The development process will include a process for the CB
to occasionally review and recommend changes to the lifecycle of a Project,
...
The CBs and entire technical community will follow any processes as may be
...
Elections shall be done within the Projects by the Collaborators active in the
Project. Each Project may elect one representative to the TAC and that
representative may be anyone from that project community.

Foundation supporting Member organizations may elect one representative to the
TAC and may use what ever means they deem fit to determine the individual who
will fill that role.
